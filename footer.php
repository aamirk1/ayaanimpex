                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="widget widget_about">
                        <div class="logo-footer clearfix">
                            <a href="index.php"><img src="<?php echo $base_url; ?>asset/images/ayan-logo.png"
                                    alt="Ayaan Forging" title="Ayaan Forging" style="background: white;
    padding: 5px;
    width: 146px;
                ...
                <div class="footer-copy-right">
                    <span class="copyrights-text">Copyright &copy; <?php echo date("Y"); ?> <a
                        ...
                        <img src="<?php echo $base_url; ?>asset/images/whatsapp-icon.png"
                            ...
                            title="Direct message to Ayaan Forging via Whatsapp"></a>
                </div>
