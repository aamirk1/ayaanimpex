    ...
    border-radius: 10px;"></a>
      ...
      <div class="col-lg-3 col-md-6">
                            <div class="widget widget_services">
                                ...
                                <ul>
                                    <li><a href="index.php" style="color:white;"><i class="fa fa-angle-double-right"></i> Home</a></li>
                                    <li><a href="about.php" style="color:white;"><i class="fa fa-angle-double-right"></i> About</a></li>
                                    <li><a href="products.php" style="color:white;"><i class="fa fa-angle-double-right"></i> Products</a></li>
                                    <li><a href="quality-policy.php" style="color:white;"><i class="fa fa-angle-double-right"></i> Quality Policy</a></li>
                                    <li><a href="contact.php" style="color:white;"><i class="fa fa-angle-double-right"></i> Contact</a></li>
                                </ul>
                            </div>
                        </div>
						      <div class="col-lg-3 col-md-6">
...
<!--
                                    <li><a href="about-1.html">Nuts Bolts</a></li>
                                    <li><a href="project-1.html">Stud Bolts</a></li>
-->
...
Morland Road, Mumbai - 400 008.</li>
									...
									<li><i class="fi fi-rr-phone-call"></i><a href="tel:+919930614069" style="color:white;">+91 99306 14069</a></li>
									<li><i class="fi fi-rr-phone-call"></i><a href="tel:+912223051060" style="color:white;">+91 22 2305 1060</a></li>
                                </ul>  
                            </div>
                        </div>
